...
const REGIONS = [
    ...
    { lat: 50.75, lng: 25.32, uk: 'Волинська', en: 'Volyn' },
    ...
    { lat: 48.62, lng: 22.3, uk: 'Закарпатська', en: 'Zakarpattia' },
    { lat: 47.85, lng: 35.14, uk: 'Запорізька', en: 'Zaporizhzhia' },
    { lat: 48.92, lng: 24.71, uk: 'Івано-Франківська', en: 'Ivano-Frankivsk' },
    { lat: 50.6, lng: 30.9, uk: 'Київська', en: 'Kyiv Oblast' },
    { lat: 48.51, lng: 32.26, uk: 'Кіровоградська', en: 'Kirovohrad' },
    { lat: 48.9, lng: 38.4, uk: 'Луганська', en: 'Luhansk' },
    { lat: 49.84, lng: 24.03, uk: 'Львівська', en: 'Lviv' },
    { lat: 50.45, lng: 30.52, uk: 'Київ', en: 'Kyiv' },
    ...
    { lat: 50.62, lng: 26.25, uk: 'Рівненська', en: 'Rivne' },
    { lat: 50.91, lng: 34.8, uk: 'Сумська', en: 'Sumy' },
    { lat: 49.55, lng: 25.59, uk: 'Тернопільська', en: 'Ternopil' },
    { lat: 49.99, lng: 36.23, uk: 'Харківська', en: 'Kharkiv' },
    { lat: 46.64, lng: 32.62, uk: 'Херсонська', en: 'Kherson' },
    { lat: 49.42, lng: 26.99, uk: 'Хмельницька', en: 'Khmelnytskyi' },
    { lat: 49.44, lng: 32.06, uk: 'Черкаська', en: 'Cherkasy' },
    { lat: 48.29, lng: 25.94, uk: 'Чернівецька', en: 'Chernivtsi' },
    { lat: 51.5, lng: 31.29, uk: 'Чернігівська', en: 'Chernihiv' },
    { lat: 45.03, lng: 34.1, uk: 'Крим', en: 'Crimea' },
];

function addRegionLabelsLayer(map, language) {
