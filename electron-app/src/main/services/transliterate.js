...
// A CommonJS copy of renderer/liveMap/transliterate.js (same table, same logic) - kept separate
// rather than shared, matching how main and renderer code stay on their own module systems
// (CommonJS vs ESM) everywhere else in this app. Used to keep Cyrillic entirely out of the log
// (event.csv) regardless of source - Excel's own double-click-to-open doesn't assume UTF-8 by
// default, so Cyrillic text left in unconverted has come out as mojibake for some readers.
