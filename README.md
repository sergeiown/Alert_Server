...
- **[Leaflet](https://leafletjs.com/)** (BSD-2-Clause) powers the Live map, together with a [fullscreen control](https://github.com/sergeiown/Leaflet_FullScreen_Button) the same author of this app wrote for it.
